          ...
          {[1, 2, 3].map((i) => (
            <div key={i} className="bg-white rounded-lg border border-line shadow-card p-5">
              <div className="flex items-start gap-3 mb-4">
                <div className="w-10 h-10 bg-[#EDF0F5] rounded-lg animate-pulse" />
                <div className="flex-1">
                  <div className="h-5 w-32 bg-[#EDF0F5] rounded animate-pulse mb-2" />
                  <div className="h-3 w-24 bg-[#EDF0F5] rounded animate-pulse" />
                </div>
              </div>
              <div className="grid grid-cols-3 gap-4 mb-4 p-3 bg-surface-alt rounded-md">
                {[1, 2, 3].map((j) => (
                  <div key={j}>
                    <div className="h-2.5 w-20 bg-[#EDF0F5] rounded animate-pulse mb-2" />
                    <div className="h-4 w-16 bg-[#EDF0F5] rounded animate-pulse" />
                  </div>
                ))}
              </div>
              <div className="flex gap-2">
                <div className="flex-1 h-9 bg-[#EDF0F5] rounded animate-pulse" />
                <div className="h-9 w-20 bg-[#EDF0F5] rounded animate-pulse" />
              </div>
            </div>
          ))}
        </div>
